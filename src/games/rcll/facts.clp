...
(deffacts startup
  ...
  (machine (name C-BS)  (team CYAN) (mtype BS)  (zone C_Z45) (rotation 0))
  (machine (name C-DS)  (team CYAN) (mtype DS)  (zone C_Z65) (rotation 270))
  (machine (name C-SS)  (team CYAN) (mtype SS)  (zone C_Z57) (rotation 90))
  (machine (name C-RS1) (team CYAN) (mtype RS)  (zone C_Z16) (rotation 90))
  (machine (name C-RS2) (team CYAN) (mtype RS)  (zone M_Z27) (rotation 90))
  (machine (name C-CS1) (team CYAN) (mtype CS)  (zone M_Z22) (rotation 135))
  (machine (name C-CS2) (team CYAN) (mtype CS)  (zone C_Z63) (rotation 180))

  (machine (name M-BS)  (team MAGENTA) (mtype BS) (zone M_Z45) (rotation 180))
  (machine (name M-DS)  (team MAGENTA) (mtype DS) (zone M_Z65) (rotation 270))
  (machine (name M-SS)  (team MAGENTA) (mtype SS) (zone M_Z57) (rotation 90))
  (machine (name M-RS1) (team MAGENTA) (mtype RS) (zone M_Z16) (rotation 90))
  (machine (name M-RS2) (team MAGENTA) (mtype RS) (zone C_Z27) (rotation 90))
  (machine (name M-CS1) (team MAGENTA) (mtype CS) (zone C_Z22) (rotation 45))
  (machine (name M-CS2) (team MAGENTA) (mtype CS) (zone M_Z63) (rotation 0))
